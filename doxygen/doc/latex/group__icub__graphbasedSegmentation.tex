...
None.\hypertarget{group__blobExtractor_portsc_sec}{}\subsection{Ports Created}\label{group__blobExtractor_portsc_sec}
...
No configuration file is needed. Parameters described in \hyperlink{group__seg2cloud_parameters_sec}{Parameters} can be provided in a configuration file; default filename is\hypertarget{group__blobExtractor_tested_os_sec}{}\subsection{Tested OS}\label{group__blobExtractor_tested_os_sec}
